...
int main(int argc, char** argv)
{
    ...
    typedef FeelModels::Heat< Simplex<2,1>,
    ...
    auto lambda = [&heat](FeelModels::ModelAlgebraic::DataUpdateLinear & data) {
    ...
    heat->algebraicFactory()->addFunctionLinearAssembly(lambda);
    // solve the problem
    heat->solve();
    heat->exportResults();
